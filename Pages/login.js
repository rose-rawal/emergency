import {Text,StyleSheet,Image, View, ImageBackground,Button, TouchableOpacity, ScrollView} from 'react-native'
...
>
   ...
   <View style={styles.buttonContainer}>
    <TouchableOpacity style={styles.button} onPress={handleLogin}>
        ...
        <ScrollView style ={styles.signUpContainer}  contentContainerStyle={{justifyContent: 'center',alignItems: 'center'}}  >
<View style= {styles.heads}>
